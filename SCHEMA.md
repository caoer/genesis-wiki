...
The thin living upstream (`C1-thin-upstream`) for the llm-wiki fleet. Its content is the contract and nothing else: contract text, checks, computed-surface definitions. Knowledge about *how to run wikis* lives here; knowledge about anything else belongs in a child wiki.
