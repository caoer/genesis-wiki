...
- **The law:** [domains/contract/genesis-contract/contract-v1.md](domains/contract/genesis-contract/contract-v1.md) — 48 numbered clauses with stable slugs. Start at the glossary; a bare reader with `rg` and that one file can learn the whole shape.
