...
- **Recommended vault setup:** [domains/operations/vault-setup/VAULT-SETUP.md](domains/operations/vault-setup/VAULT-SETUP.md) — Obsidian baseline for llm-wiki operators: enforce the lowercase-kebab filename convention with the Vault File Renamer plugin (guidance, not law; not part of the install payload).
