---
description: Worked example domain — real content that teaches the domain shape; a filled index, a leaf with provenance, computed-catalog discipline. Delete this domain once your first real one exists.
tags: [type/domain-index, domain/example]
created: {{YYYY-MM-DD}}
---

# pour-over-coffee (example — copy the shape, then delete me)
...
Leaves: [[grind-size]] — one topic per page, provenance in frontmatter.
