...
description: "Genesis fork — operative law source. No commit:/branch: fields by design — genesis provenance is the birth commit message (contract C6-manifest, `C38-point-or-own`)."
tags: [type/repo]
created: {{YYYY-MM-DD}}
---
